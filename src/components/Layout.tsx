...
import { Package, Users, Users2, LogOut, ChevronDown, Menu, X, ShoppingCart, BarChart3, Settings, Palette, TrendingUp } from 'lucide-react';
...
const navItems = [
  ...
  { to: '/trending', label: 'Trending', icon: TrendingUp, roles: ['admin'] },
